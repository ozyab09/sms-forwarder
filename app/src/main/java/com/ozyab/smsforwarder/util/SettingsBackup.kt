...
object SettingsBackup {
    ...
    fun export(): JSONObject {
        val settings = JSONObject()
            ...
            .put("outgoingSmsEnabled", Prefs.outgoingSmsEnabled)
            .put("callsEnabled", Prefs.callsEnabled)
            .put("incomingCallsEnabled", Prefs.incomingCallsEnabled)
            .put("outgoingCallsEnabled", Prefs.outgoingCallsEnabled)
            .put("notificationsEnabled", Prefs.notificationsEnabled)
            .put("notificationApps", Prefs.notificationApps)
            .put("themeMode", Prefs.themeMode)
            .put("accentColor", Prefs.accentColor)
            .put("messageTemplateSms", Prefs.messageTemplateSms)
            .put("messageTemplateOutgoingSms", Prefs.messageTemplateOutgoingSms)
            .put("messageTemplateCall", Prefs.messageTemplateCall)
            .put("messageTemplateIncomingCall", Prefs.messageTemplateIncomingCall)
            .put("messageTemplateOutgoingCall", Prefs.messageTemplateOutgoingCall)
            .put("messageTemplateNotification", Prefs.messageTemplateNotification)
    ...
    fun import(json: JSONObject): ImportResult {
        ...
        Prefs.outgoingSmsEnabled = settings.optBoolean("outgoingSmsEnabled", Prefs.outgoingSmsEnabled)
        Prefs.callsEnabled = settings.optBoolean("callsEnabled", Prefs.callsEnabled)
        Prefs.incomingCallsEnabled = settings.optBoolean("incomingCallsEnabled", Prefs.incomingCallsEnabled)
        Prefs.outgoingCallsEnabled = settings.optBoolean("outgoingCallsEnabled", Prefs.outgoingCallsEnabled)
        Prefs.notificationsEnabled = settings.optBoolean("notificationsEnabled", Prefs.notificationsEnabled)
        Prefs.notificationApps = settings.optString("notificationApps", Prefs.notificationApps)
        Prefs.themeMode = settings.optString("themeMode", Prefs.themeMode)
        Prefs.accentColor = settings.optString("accentColor", Prefs.accentColor)
        Prefs.messageTemplateSms = settings.optString("messageTemplateSms", Prefs.messageTemplateSms)
        Prefs.messageTemplateOutgoingSms = settings.optString("messageTemplateOutgoingSms", Prefs.messageTemplateOutgoingSms)
        Prefs.messageTemplateCall = settings.optString("messageTemplateCall", Prefs.messageTemplateCall)
        Prefs.messageTemplateIncomingCall = settings.optString("messageTemplateIncomingCall", Prefs.messageTemplateIncomingCall)
        Prefs.messageTemplateOutgoingCall = settings.optString("messageTemplateOutgoingCall", Prefs.messageTemplateOutgoingCall)
        Prefs.messageTemplateNotification = settings.optString("messageTemplateNotification", Prefs.messageTemplateNotification)
