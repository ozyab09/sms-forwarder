...
- ⏹️ **Полная остановка** — кнопка «Стоп» действительно останавливает пересылку до «Запустить» (новые SMS/звонки не возобновят её)
...
| **Статус** | Кнопки «Запустить»/«Стоп»: «Стоп» останавливает пересылку до следующего «Запустить» (мастер-выключатель). |
